 ...
 * @public
 */
export declare const productEntityV1alpha1Validator: KindValidator;
/**
 * Typeguard for filtering entities and ensuring v1alpha1 entities
 * @public
 */
export declare const isProductEntityV1alpha1: (entity: Entity) => entity is ProductEntityV1alpha1;
